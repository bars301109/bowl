  ...
  try{
    ...
    if(!sAny){
      ...
      await runAsync(`INSERT INTO settings (id,badge1_ru,badge1_ky,badge2_ru,badge2_ky,badge3_ru,badge3_ky,day1_date,day2_date,day3_date,final_place_ru,final_place_ky,updated_at) VALUES (1,?,?,?,?,?,?,?,?,?,?,?,${nowFunc})`, [
        DEFAULT_SETTINGS.badge1_ru,
        DEFAULT_SETTINGS.badge1_ky,
        DEFAULT_SETTINGS.badge2_ru,
        DEFAULT_SETTINGS.badge2_ky,
        DEFAULT_SETTINGS.badge3_ru,
        DEFAULT_SETTINGS.badge3_ky,
        DEFAULT_SETTINGS.day1_date,
        DEFAULT_SETTINGS.day2_date,
        DEFAULT_SETTINGS.day3_date,
        DEFAULT_SETTINGS.final_place_ru,
        DEFAULT_SETTINGS.final_place_ky
      ]);
    }
...
app.get('/api/categories', async (req,res)=>{
  try{
    ...
    try{
      ...
      const fallback = DEFAULT_CATEGORIES.map((c, idx) => ({
        id: idx + 1,
        name_ru: c.ru,
        name_ky: c.ky,
        desc_ru: c.desc_ru,
