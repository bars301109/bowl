(function(){
  const DICTS = {
    ru: {
      ...
      'how.team': 'О составе команды',
      'how.team.desc': '* Команда должна состоять из учеников 8-10 классов. * Все члены команды должны быть из одной школы. * В команде должно быть от 2 до 4 человек.',
      'how.cats': 'Категории',
      ...
      'footer.cta_subtitle': 'Присоединяйтесь к интеллектуальному турниру для школьников и откройте новые возможности для своей команды.',
      'footer.cta_button': 'Зарегистрировать команду',
      'footer.student_project': 'Этот проект — учебный проект, созданный учениками 10 класса Президентского лицея «Акылман».',
      ...
      'login.email.placeholder': 'Введите email капитана',
      ...
      'register.team_name.placeholder': 'Например: Шумкарлар',
      'register.password.placeholder': 'Введите пароль',
      'register.password2.placeholder': 'Повторите пароль',
      'register.captain_name.placeholder': 'Иванов Иван Иванович',
      'register.captain_email.placeholder': 'example@email.com',
      'register.captain_phone.placeholder': '+996 555 123456',
      'register.school.placeholder': 'Название школы',
      'register.city.placeholder': 'Город',
      'register.category': 'Категория',
      'register.category.placeholder': 'Выберите категорию',
      'register.member_name.placeholder': 'ФИО участника',
      'register.member_class.placeholder': 'Класс',
      ...
      'team.welcome': 'Кабинет команды',
      'team.edit': 'Изменить',
      'team.change_password': 'Изменить пароль',
      'team.edit_members': 'Редактирование участников',
      'team.edit_members_description': 'Добавьте или измените участников команды:',
      'team.add_member': '+ Добавить участника',
      'team.member_name': 'Имя участника',
      'team.member_class': 'Класс',
      'team.save': 'Сохранить',
      'team.cancel': 'Отмена',
      'team.saving': 'Сохранение...',
      'team.edit_field': 'Редактирование',
      'team.enter_value': 'Введите значение',
      'team.save_success': 'Изменения успешно сохранены',
      'team.save_error': 'Не удалось сохранить изменения',
    ...
    ky: {
      ...
      'how.team': 'Топтун курамы жөнүндө',
      'how.team.desc': '* Топтордун курамы 8-10 класстардын окуучуларынан туруусу зарыл. * Топтун мүчөлөрү бир мектептен болуусу зарыл. * Бир топто 2-4кө чейин мүчө болуу керек.',
      ...
      'footer.cta_title': 'Акылманга сапар алыңыз!',
      'footer.cta_subtitle': 'Орто жана жогорку класстын окуучулары үчүн интеллектуалдык турнирге кошулуңуз жана командаңыз менен жаңы мүмкүнчүлүктөрдү ачкыла.',
      'footer.cta_button': 'Команданы каттоо',
      'footer.student_project': 'Бул долбоор — «Акылман» Президенттик лицейинин 10-классынын окуучулары тарабынан түзүлгөн окуу долбоору.',
      ...
      'login.email.placeholder': 'Капитандын электрондук почтасын киргизиңиз',
      'login.password.placeholder': 'Сырсөздү киргизиңиз',
      ...
      'register.city': 'Мектептин адреси',
      'register.category': 'Категория',
      'register.category.placeholder': 'Категорияны тандаңыз',
      ...
      'register.team_name.placeholder': 'Мисалы: Шумкарлар',
      'register.password.placeholder': 'Сырсөздү киргизиңиз',
      'register.password2.placeholder': 'Сырсөздү кайра киргизиңиз',
      'register.captain_name.placeholder': 'Мисалы: Асанов Улукбек',
      'register.captain_email.placeholder': 'misal@email.com',
      'register.captain_phone.placeholder': '+996 555 123456',
      'register.school.placeholder': 'Мектептин аты',
      'register.city.placeholder': 'Шаар же дарек',
      'register.member_name.placeholder': 'Катышуучунун аты-жөнү',
      'register.member_class.placeholder': 'Класс',
      ...
      'team.welcome': 'Команданын кабинети',
      'team.edit': 'Өзгөртүү',
      'team.change_password': 'Парольду өзгөртүү',
      'team.edit_members': 'Катышуучуларды редакциялоо',
      'team.edit_members_description': 'Топтун катышуучуларын кошуңуз же өзгөртүңүз:',
      'team.add_member': '+ Катышуучу кошуу',
      'team.member_name': 'Катышуучунун аты',
      'team.member_class': 'Класс',
      'team.save': 'Сактоо',
      'team.cancel': 'Жокко чыгаруу',
      'team.saving': 'Сакталууда...',
      'team.edit_field': 'Редакциялоо',
      'team.enter_value': 'Маанини киргизиңиз',
      'team.save_success': 'Өзгөрүүлөр ийгиликтүү сакталды',
      'team.save_error': 'Өзгөрүүлөрдү сактоо мүмкүн болбоду',
