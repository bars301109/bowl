(function(){
  const DICTS = {
    ru: {
      ...
      'footer.student_project': 'Этот сайт — учебный проект, созданный учениками 10 класса Президентского лицея «Акылман».',
    ...
    ky: {
      ...
      'footer.student_project': 'Бул сайт — «Акылман» Президенттик лицейинин 10-класстын окуучулары тарабынан түзүлгөн окуу долбоору.',
