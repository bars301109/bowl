...
в ПК версии надо чтобы галерея была на всю ширину экрана, и пролистнутая картинка должна вскоре выйти там опять, то есть картинки должны стать по типу "бегущего текста". А в мобильной версии добавь скругление углов для картинок, остальное ничего не меняй.

Исапользуй в кыргызском не декабря а декабрь.

также затронем окно регистрации. В кыргызском варианте вместо "Капитандын ФИО" пиши "Капитандын аты-жөнү", вместо "Капитандын Email" пиши "Капитандын электронндук почтасы", Вместо "Шаар" пиши "Мектептин адреси"(также и в русской версии), в кыргызской версии вместо "Участник X ФИО" пиши "x-катышуучунун аты-жөнү". В русской версии пиши "ФИО второго(или какой он по счету) участника". Вместо "Класс/роль" в кыргызской версии пиши "Классы" а в русской "Класс"

Также при проверке пароля между текстами-флажочками(8 Characters

Number

Lowercase

Uppercase) не должно быть отступов. И еще они должны менять свой цвет в зависимости выполнено ли условие. Реализуй